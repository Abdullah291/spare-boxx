...
class ViewBrandScreen extends StatelessWidget {
  ViewBrandScreen({Key? key}) : super(key: key);
  ViewBrandController viewBrandController = Get.find<ViewBrandController>();
    ...
    return Scaffold(
      ...
      body: SingleChildScrollView(
          ...
          child: Column(
              ...
              children: [
                GetBuilder<ViewBrandController>(builder: (controller) {
                  return controller.obx(
                      ...
                      child: Wrap(
                          ...
                          children: List.generate(
                              controller.viewBrandModel?.listing?.length ?? 0, (index) {
                            Listing? am = controller.viewBrandModel
                                ?.listing?[index];

                            if (mobileStorage == null
                                ? am?.countryId == am?.countryId
                                : mobileStorage?.countryId ==
                                am?.countryId) {
                    ...
                    onError: (error) => "No Data"
                        ...
                        .make()
                        .marginOnly(top: Get.height*0.3, bottom: 200).centered(),
                  );
                }).box
